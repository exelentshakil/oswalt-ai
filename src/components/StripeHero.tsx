          ...
          <div className="lg:col-span-7 space-y-6">
            ...
            <div className="pt-8 border-t border-[var(--color-border)]/80 max-w-2xl">
              ...
              <div className="flex flex-wrap items-center justify-between gap-5 opacity-90 grayscale hover:grayscale-0 transition-all">
                <span className="text-[14px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">FastAPI</span>
                <span className="text-[14px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Angular</span>
                <span className="text-[14px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Neo4j Graph</span>
                <span className="text-[14px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Google Cloud</span>
                <span className="text-[14px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Docker</span>
                <span className="text-[14px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">NIST AI RMF</span>
                <span className="text-[14px] sm:text-base font-bold tracking-tight text-[var(--color-text-primary)] font-sans">Python Async</span>
              </div>
            </div>
          </div>
